...
RUN echo "options(repos = c(CRAN = 'https://bioconductor.org/packages/3.11/bioc', CRAN = 'https://cran.rstudio.com'), download.file.method = 'libcurl')" >> /usr/local/lib/R/etc/Rprofile.site
...
RUN Rscript -e 'remotes::install_version("epivizrChart",upgrade="never", version = "1.10.0")'
...
RUN Rscript -e 'remotes::install_github("jacobwindsor/igvShiny@bd4063e23bbebec5d90e6257ef7778961cf8b1ea")'
